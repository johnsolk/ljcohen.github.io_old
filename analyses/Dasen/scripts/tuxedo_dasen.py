...
def assembly_file(transcripts_output,basedir):
    ...
    #assembly_filename=assembly_file=basedir+"tuxedo_4_Steve_gtf/cufflinks/assemblies.txt"
    #assembly_filename=assembly_file=basedir+"tuxedo_2/cufflinks/assemblies.txt"
    #assembly_filename=assembly_file=basedir+"tuxedo_3_UCSC/cufflinks/assemblies.txt"
...
def tuxedo_pipeline_cuffmerge(basedir,annotation,reference,reference_fasta,assembly_filename):
    ...
    #cuffmerge_dir=basedir+"tuxedo_4_Steve_gtf/cufflinks/merged_asm/"
    #cuffmerge_dir=basedir+"tuxedo_2/cufflinks/merged_asm/"
    #cuffmerge_dir=basedir+"tuxedo_3_UCSC/cufflinks/merged_asm/"
...
def run_cuffdiff(basedir,cxb_output,reference_fasta,cuffmerge_file):
    ...
    #cuffdiff_outputdir=basedir+"tuxedo_3_UCSC/cuffdiff/"
    #cuffdiff_outputdir=basedir+"tuxedo_2/cuffdiff/"
    cluster.check_dir(cuffdiff_outputdir)
    ...
    threads="32"
    process_name="cuffdiff_32threads"
    module_list=["cufflinks/2.2.0"]
