...
resultsNames(cds)
### generate MA plots
#write.csv(counts(cds,normalized=TRUE),"Dasen_norm_counts.csv")
...
#write.csv(merge_biomart_res_all,"Dasen_Thoracic_Mutant_vs_Control_CPM_all.csv")
res_merged_cutoff<-subset(merge_biomart_res_all,merge_biomart_res_all$padj<0.05)
#write.csv(res_merged_cutoff,"Dasen_Thoracic_Mutant_vs_Control_CPM_padj0.05.csv")
###
up_down_1FC<-subset(res_merged_cutoff,res_merged_cutoff$log2FoldChange>1 | res_merged_cutoff$log2FoldChange< -1)
write.csv(up_down_1FC,file="Thoracic_updownFC1_padj0.05_June2015.csv")
#d<-up_down_1FC
...
write.csv(up_1FC,file="Thoracic_upFC1_padj0.05_June2015.csv")
#d<-up_down_1FC
...
write.csv(down_1FC,file="Thoracic_downFC1_padj0.05_June2015.csv")
#d<-up_down_1FC
