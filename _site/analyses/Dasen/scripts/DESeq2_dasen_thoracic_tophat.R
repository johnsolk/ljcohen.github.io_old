...
setwd("~/Documents/Dasen/thoracic/htseq_counts/tophat_htseq")
mypath<-"~/Documents/Dasen/thoracic/htseq_counts/tophat_htseq"
...
colnames(data)
d.filt <- apply(data,1,function(row) all(row!=0))
data <- data[d.filt,]
