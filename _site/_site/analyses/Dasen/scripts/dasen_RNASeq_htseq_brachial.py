...
def get_fileslist(fileslist_all,filesdir):
    fileslist=[]
    for filename in fileslist_all:
        new_filename=filesdir+filename
...
filesdir="/ifs/home/cohenl06/data/sequencing/dasen/brachial/fastq/"
basedir="/ifs/home/cohenl06/data/sequencing/dasen/brachial/htseq/"
cluster.check_dir(basedir)
